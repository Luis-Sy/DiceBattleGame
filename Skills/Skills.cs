...
namespace DiceBattleGame.GameData.Skills
{
    ...
    { //TO DO add skill descriptions
        ...
        internal virtual int UseSkill(Character entity, Character enemy) //These overloads allow a flexible number of inputs please look carefully and expand or modify as needed - J
        {
            return 0;
        }
